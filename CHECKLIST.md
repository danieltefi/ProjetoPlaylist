...
- [ ] Ativar o ambiente virtual e criar o arquivo `requirements.txt`.
- [ ] **Estrutura de Pastas:** Criar diretório `classes/` para os módulos e `main.py` para o ponto de entrada.
